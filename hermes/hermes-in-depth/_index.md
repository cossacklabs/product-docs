...
* [Model, process, entity](/hermes/hermes-in-depth/model-process-entity/).
* [Architecture](/hermes/hermes-in-depth/architecture/).
* [API design](/hermes/hermes-in-depth/api-design/).
* [Low-level API](/hermes/hermes-in-depth/low-level-api/).
