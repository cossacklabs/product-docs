...
Welcome to the official documentation for Hermes. This is a full searchable general documentation for Hermes. 
We also advise you checking out the [Advanced section](https://docs.cossacklabs.com/products/hermes/#advanced) 
and [Tutorials &amp; How Tos section](/products/hermes/#tutorials) on the [main Hermes-core documentation page](/products/hermes/).
...
Hermes relies on stacking several cryptographic processes (symmetric and asymmetric encryption without interactive key exchange, MACs) and managing keys/data structures/encryption scopes. It uses battle-proven cryptographic algorithms and their implementations and is built using special encryption abstraction [library Themis](/products/themis/), which allows swapping problematic crypto-primitives or even whole algorithm families without changing a line of high-level code.

Access is managed via private keys, sharing, and permission set assignments. These procedures rely on the use of Public Key Infrastructure. A bare-bones version of such infrastructure is aimed at [easy integration](#сredential-store) using a simple flat file storage because Hermes is aimed at integration with any data and trust sources.
...
Drop us an email to [info@cossacklabs.com](mailto:info@cossacklabs.com) if you are interested in commercial license for [Hermes](https://docs.cossacklabs.com/products/hermes/) or support.
