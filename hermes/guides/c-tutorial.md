...
The similar tutorial is also available for Python [here](https://docs.cossacklabs.com/pages/python-tutorial-hermes/) and [Golang](https://docs.cossacklabs.com/pages/go-tutorial-hermes/)